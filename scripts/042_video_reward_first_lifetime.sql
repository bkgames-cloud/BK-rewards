-- Vidéos récompensées : +2 pts pour la toute première vidéo (lifetime), puis +1 par vidéo
-- (remplace le bonus « première pub du jour »).
...
BEGIN
  ...
  SELECT COUNT(*)::INTEGER INTO v_lifetime
  FROM video_views
  WHERE user_id = v_user_id;
