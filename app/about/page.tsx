        ...
        <Card className="w-full max-w-2xl border-border bg-card">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4 text-foreground">
              <p className="text-lg leading-relaxed">Salut ! Je suis le créateur de cette plateforme.</p>

              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-foreground">Pourquoi j&apos;ai lancé BKG Rewards ?</h3>
                <p className="leading-relaxed text-muted-foreground">
                  Parce que je trouvais ça injuste que les grandes plateformes profitent de votre attention sans jamais
                  rien vous rendre en retour.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="leading-relaxed text-muted-foreground">
                  Vous donnez quelques secondes de votre temps pour regarder une publicité, et en échange, je redistribue
                  les revenus sous forme de cadeaux réels (iPhone, consoles, cartes cadeaux). C&apos;est un contrat
                  gagnant-gagnant. Plus la communauté BKG Rewards grandit, plus les lots deviennent énormes !
                </p>
              </div>
